...
const rectArealLight = new THREE.RectAreaLight(0x4e00ff, 6,3,1)
scene.add(rectArealLight)

const rectArealLightHelper = new RectAreaLightHelper(rectArealLight, 0.4)
